...
import { 
    ChevronLeftIcon, 
    ChevronRightIcon, 
    SparkleIcon, Star, StarIcon } from "lucide-react";
...
export const Testimonials = () => {
    ...
    >
        ...
        <h2 
            className='text-4xl sm:text-4xl font-bold capitalize mt-2 md:max-w-3xl'
        >
        ...
        <div className="mt-10 relative w-full">
            <AnimatePresence mode='wait'>
                ...
                >
                    <img src={testimonials[curSlide].image} alt={testimonials[curSlide].name}
