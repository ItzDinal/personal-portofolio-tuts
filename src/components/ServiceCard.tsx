...
export const ServiceCard = ({ service }: { service: ServiceType }) => {
    return (
    <div className="flex iems-start justify-between rounded-2xl border border-neutral-700 p-8 hover:bg-zinc-900 transition-all duration-300 hover:border-primary relative">
        <div>
